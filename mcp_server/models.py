...
#   timestamp: 2025-06-28T15:06:39+00:00
...
class CertificateParameters(BaseModel):
    ...
    RROLL: str = Field(..., description='Student Roll Number', examples=['17001020013'])
    SEM: str = Field(
        ...,
        description='Semester / Year',
        examples=[
            '1 / First Year,2 / First Year,3 / Second Year,4 / Second Year,5 / Third Year,6 / Third Year'
        ],
    )
